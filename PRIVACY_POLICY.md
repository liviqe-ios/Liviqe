...
- We **do not use** analytics tools, tracking technologies, cookies, or third-party SDKs.  
- We **do not access** contacts, photos, location, camera, microphone, or any other device data.  
- We **do not require** account creation, login, or user identification.  

All functionality of the App operates **entirely locally on your device**.

## Data Storage and Responsibility

Any data created, entered, or stored while using the App exists **only on your device**.  

- We have **no access** to this data.  
- We **cannot recover**, restore, or transfer your data.  
- You are solely responsible for managing backups and data integrity.  
...
- We **disclaim all responsibility and liability** for any loss of data, corruption of data, or unintended deletion of data.  
- We are **not liable** for any damages, direct or indirect, arising from the use or inability to use the App.  
- We are **not responsible** for device malfunctions, operating system issues, third-party software conflicts, or user error.  
...
- Any changes will be posted in this document.  
